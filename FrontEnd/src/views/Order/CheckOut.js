...
function CheckOut() {
  ...
  const getThumbnail = (images = []) => {
    ...
    return thumb ? thumb.imageUrl : "/no-image.png";
  };
                      ...
                      <div key={product.productId} className="row no-gutters">
                        <div className="col-md-4">
                          <img
                            ...
                            alt={product.img1}
                            style={{ width: "100%", height: "69px",objectFit: "cover",  borderRadius: "6px", }}
                          />
                        </div>
                        <div className="col-md-8">
                          <li className="list-group-item d-flex justify-content-between lh-condensed">
                            <div>
                              <h6 className="my-0">{`${product.title} (x ${product.quantity})`}</h6>
                    ...
                    >
                      ...
                      {type.cdVal === 4 && (
                        ...
                        >
                          ...
                          nhận về địa chỉ <strong>vnuawatch@gmail.com</strong>{" "}
                          với nội dung: Thanh toán đơn hàng: [Mã đơn]
                        </p>
                      )}
                    </div>
                  ))}
