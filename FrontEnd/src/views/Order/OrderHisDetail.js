...
function OrderHisDetail({ p_order, openDialogDetail, closeFormDetail }) {
  ...
  const trackId = (p_order && p_order.track_Id) ?? "";

  useEffect(() => {
    let ac_set_type = allcodes.filter(
      (item) => item.cdName == "ORDER" && item.cdType == "SETTLE_TYPE"
    );
    if (ac_set_type) setSettle_Types(ac_set_type);
    ...
    if (order_statuss) setOrder_statuss(order_statuss);
  }, [allcodes]);
  ...
  return (
    ...
    >
      ...
      <div style={{ minWidth: "900px", overflowY: "auto", minHeight: "600px" }}>
          ...
          <div className="container">
            ...
            <div className="row">
              ...
              >
                ...
                <Stepper
                  activeStep={order_statuss.findIndex(
                    (item) => item.cdVal === order.order_Status
                  )}
                  alternativeLabel
                >
                  {order_statuss &&
                    Array.isArray(order_statuss) &&
                    order_statuss.map((type) => (
            ...
            <div className="row" width="92%">
              <table
                className="table"
                style={{ border: "2px solid", margin: "20px 20px 30px 20px" }}
              >
                <tbody>
                  {order &&
                    order.orderTrackings &&
                    Array.isArray(order.orderTrackings) &&
                    order.orderTrackings.map((trackDetail, index) => {
                      return (
                        <tr key={trackDetail.update_Status_Date}>
                          ...
                          >
                            {DateTimeDisplay_1(trackDetail.update_Status_Date)}
                          </td>
              ...
              <div className="col-md-5 order-md-2 mb-4">
                ...
                <ul className="list-group mb-3">
                          ...
                          <div className="col-md-8">
                            <li className="list-group-item d-flex justify-content-between lh-condensed">
                              ...
                              <span className="text-muted">
                                {formatNumberWithCommas(product.price)} VNĐ
                              </span>
                            </li>
                          </div>
                        </div>
                  ...
                  <li className="list-group-item d-flex justify-content-between">
                    <span>Tổng tiền: </span>
                    <strong>
                      {formatNumberWithCommas(order.total_Order_Value)} VNĐ
                    </strong>
                  </li>
                </ul>
              </div>
              <div className="col-md-7 order-md-1">
                ...
                <form className="needs-validation" noValidate>
                  ...
                  <div className="d-block my-3">
                    {settle_Types !== undefined &&
                      settle_Types !== null &&
                      Array.isArray(settle_Types) &&
                        ...
                        return (
                          ...
                          >
                            <input
                              ...
                              defaultChecked={
                                type ?? type.cdVal == order.settle_Type
                                  ? true
                                  : false
                              }
                              disabled={true}
